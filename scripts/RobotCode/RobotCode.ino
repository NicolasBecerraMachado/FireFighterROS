...
#define MOT4_IN2 48//IN1 of the L298 should be connected to this arduino pin
#define MOT4_IN1 46//IN2 of the L298 should be connected to this arduino pin
#define MOT3_IN2 52//IN3 of the L298 should be connected to this arduino pin
#define MOT3_IN1 50//IN4 of the L298 should be connected to this arduino pin
#define MOT1_IN2 44//IN1 of the L298 should be connected to this arduino pin
#define MOT1_IN1 42//IN2 of the L298 should be connected to this arduino pin
#define MOT2_IN2 40//IN3 of the L298 should be connected to this arduino pin
#define MOT2_IN1 38//IN4 of the L298 should be connected to this arduino pin
...
Encoder Motor[4] = {{19,24}, {18,22}, {21,28}, {20,26}};
...
void pan_cb(const std_msgs::UInt8 &msg) {
    pan_servo.write(msg.data);  
  
}

void tilt_cb(const std_msgs::UInt8 &msg){
    tilt_servo.write(msg.data);
}

void pump_cb(const std_msgs::Int8 &msg){
  if(msg.data > 0){
...
ros::Subscriber<std_msgs::Int8> pump_sub("arduino/pump", pump_cb);
...
void loop() {
        ...
        speeds.publish(&strmsg);
         ...
         /*for (pan_pos = 0; pan_pos <= 180; pan_pos += 1) { // goes from 0 degrees to 180 degrees
            ...
            tilt_servo.write(pan_pos);              // tell servo to go to position in variable 'pos'
